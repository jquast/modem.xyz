...
The list of BBSs scanned is hosted on Github and all scanning and all other files but this one is
auto-generated by code. Suggest a change to `mudlist.txt
