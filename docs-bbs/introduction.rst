...
The list of muds scanned is hosted on Github and all scanning and all other files but this one is
auto-generated by code. Suggest a change to `bbslist.txt
<https://github.com/jquast/modem.xyz/blob/master/bbslist.txt>`_ to add or remove or fix an encoding
